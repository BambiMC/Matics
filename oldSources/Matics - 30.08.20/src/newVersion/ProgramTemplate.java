...
public class ProgramTemplate extends JFrame {
	 ...
	 * Create the panel.
	 */
	public ProgramTemplate(JFrame f, String[] settings, LanguageInterface language, LookAndFeel laf, Font font, Font titleFont) {
