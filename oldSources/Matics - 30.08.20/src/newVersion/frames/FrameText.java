...
public class FrameText {
	 ...
	 * Create the panel.
	 */
	public static void Text(JFrame f, String[] settings, LanguageInterface language, LookAndFeel laf, Font font, Font titleFont) {

		// init-Stuff
		JPanel p = new JPanel(new MigLayout("", "[][]", "[][][][][][]"));
		f.setContentPane(p);
		String[] lang = language.FrameText();
		...
		JButton buttonCompareText = new JButton(lang[1]);
		buttonCompareText.addActionListener(new ActionListener() {
		...
		buttonCompareText.setFont(font);
		p.add(buttonCompareText, "cell 0 1 2 1, width 200!");

		JButton buttonFindReplace = new JButton(lang[2]);
		buttonFindReplace.addActionListener(new ActionListener() {
		...
		buttonFindReplace.setFont(font);
		p.add(buttonFindReplace, "cell 0 2 2 1, width 200!");
