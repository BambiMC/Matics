package newVersion.frames.chemistry;
...
public class FrameOrganicChemistry {

	/**
	 * Create the panel.
	 */
	public static void OrganicChemistry(JFrame f, String[] settings, LanguageInterface language, LookAndFeel laf, Font font, Font titleFont) {

		// init-Stuff
		JPanel p = new JPanel(new MigLayout("", "[][]", "[][][][][][]"));
		f.setContentPane(p);
		String[] lang = language.FrameOrganicChemistry();
		...
		/*
		 * JButton buttonMath = new JButton(lang[1]); buttonMath.addActionListener(new ActionListener() {
		 * 
		 * public void actionPerformed(ActionEvent e) {
		 * 
		 * 
		 * 
		 * } }); buttonMath.setFont(font); p.add(buttonMath, "cell 0 1 2 1, width 200!");
		 * 
		 * 
		 * 
