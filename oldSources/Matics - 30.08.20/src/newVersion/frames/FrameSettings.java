...
public class FrameSettings {
	 ...
	 * Create the panel.
	 */
	public static void Settings(JFrame f, String[] settings, LanguageInterface language, LookAndFeel laf, Font font, Font titleFont) {

		// init-Stuff
		JPanel p = new JPanel(new MigLayout("", "[][]", "[][][][][][]"));
		f.setContentPane(p);
		String[] lang = language.FrameSettings();
		...
		JButton buttonSettings = new JButton(lang[1]);
		...
		p.add(buttonSettings, "cell 0 1 2 1, width 200!");

		JButton buttonContact = new JButton(lang[2]);
		...
		buttonContact.setFont(font);
		p.add(buttonContact, "cell 0 2 2 1, width 200!");
