...
public class FrameComputerScience {

	/**
	 * Create the panel.
	 */
	public static void ComputerScience(JFrame f, String[] settings, LanguageInterface language, LookAndFeel laf, Font font, Font titleFont) {

		// init-Stuff
		JPanel p = new JPanel(new MigLayout("", "[][]", "[][][][][][]"));
		f.setContentPane(p);
		String[] lang = language.FrameComputerScience();
		...
		JButton buttonMaticScript = new JButton(lang[1]);
		buttonMaticScript.addActionListener(new ActionListener() {
		...
		buttonMaticScript.setFont(font);
		p.add(buttonMaticScript, "cell 0 1 2 1, width 200!");

		JButton buttonSort = new JButton(lang[2]);
		...
		buttonSort.setFont(font);
		p.add(buttonSort, "cell 0 2 2 1, width 200!");
