...
public class FrameTemplate {
	 ...
	 * Create the panel.
	 */
	public static void Template(JFrame f, String[] settings, LanguageInterface language, LookAndFeel laf, Font font, Font titleFont) {
		...
		buttonMath.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				FrameTemplate.Template(f, settings, language, laf, font, titleFont);
				f.revalidate();
