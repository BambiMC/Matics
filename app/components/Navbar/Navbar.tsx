        ...
        <div>
          <div className="flex items-center justify-between dark:">
            ...
            <div className='flex px-2'>
              <Button addClasses='hidden xl:block border-none' onClick={() => handleLangButtonClick('en')}>EN</Button>
              <Button addClasses='hidden xl:block border-none' onClick={() => handleLangButtonClick('de')}>DE</Button>
              <Button addClasses='hidden xl:block border-none' onClick={() => handleLangButtonClick('es')}>ES</Button>
              <Button addClasses='hidden xl:block border-none' onClick={() => handleLangButtonClick('fr')}>FR</Button>
              <Button addClasses='hidden xl:block pr-8 border-none' onClick={() => handleLangButtonClick('jp')}>JP</Button>
              <button onClick={toggleLangMenu} className='xl:hidden px-3' title='Change Language'>
                <svg
                  height="32"
                  width="32"
          ...
          <div className='px-2 hidden xl:hidden' id='lang-menu'>
            <div className="absolute top-20 right-2 border rounded border-gray-300 flex flex-row">
              <Button onClick={() => handleLangButtonClick('en')} addClasses='border-none'>EN</Button>
              <Button onClick={() => handleLangButtonClick('de')} addClasses='border-none'>DE</Button>
              <Button onClick={() => handleLangButtonClick('es')} addClasses='border-none'>ES</Button>
              <Button onClick={() => handleLangButtonClick('fr')} addClasses='border-none'>FR</Button>
              <Button onClick={() => handleLangButtonClick('jp')} addClasses='border-none'>JP</Button>
            </div>
          </div>
